      ...
      <main className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 overflow-y-auto">
        <div className="w-full max-w-sm flex flex-col justify-center">
          ...
          <div className="text-center lg:text-left mb-6">
            ...
            <p className="text-[14px] text-on-surface-variant mt-1">Ingresa a tu cuenta para continuar.</p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleLogin}>
            ...
            <button type="submit" disabled={loading} className="w-full flex items-center justify-center gap-2 py-3 px-4 border-2 border-secondary rounded-lg shadow-sm text-[16px] font-semibold text-on-secondary-container bg-secondary-container hover:opacity-90 transition-all active:scale-[0.98] disabled:opacity-50 cursor-pointer">
